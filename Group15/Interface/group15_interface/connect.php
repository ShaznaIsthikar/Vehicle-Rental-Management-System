                        ...
                        <nav class="navbar navbar-inverse navbar-toggleable-md">
                           ...
                           <div class="collapse navbar-collapse justify-content-md-center" id="cloapediamenu">
                              <ul class="navbar-nav">
                                 ...
                                 <li class="nav-item">
                                    <a class="nav-link color-grey-hover" href="signup.html">Sign up</a>
                                 </li>
                     ...
                     <div class="row">
                        <div class="col-md-8 offset-md-2">
                           <div class="form_cont">
							...
							$result = mysql_query("SELECT * FROM customer WHERE username = '" . $NIC_No . "'")
							or die(mysql_error());
							...
							$stmt = $conn->prepare("insert into customer(CustomerName,CustomerNIC,Address,ContactNumber) values(?, ?, ?, ?)");
							$stmt->bind_param("sssi",$Name,$NIC_No,$address,$phone);
							$stmt->execute();
							//echo $execval;
